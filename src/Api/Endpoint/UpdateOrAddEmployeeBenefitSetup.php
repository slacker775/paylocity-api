...
class UpdateOrAddEmployeeBenefitSetup extends \Jane\OpenApiRuntime\Client\BaseEndpoint implements \Jane\OpenApiRuntime\Client\Psr7Endpoint
{
    protected $companyId;
    ...
    {
        return str_replace(['{companyId}', '{employeeId}'], [$this->companyId, $this->employeeId], '/v2/companies/{companyId}/employees/{employeeId}/benefitSetup');
    }
